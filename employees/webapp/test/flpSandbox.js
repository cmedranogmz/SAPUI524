		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employees App",
									"targetURL": "#fioriemployees-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fioriemployees-display": {
								"semanticObject": "fioriemployees",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fiori.employees",
									"url": sap.ui.require.toUrl("fiori/employees")
								}
							}
						}
					}
