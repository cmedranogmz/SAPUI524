			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"alfalistapp-display": {
								"semanticObject": "alfalistapp",
								"action": "display",
								"description": "An SAP Fiori list application.",
								"title": "List App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=alfa.listapp",
									"url": sap.ui.require.toUrl("alfa/listapp")
								}
							}
						}
					}
